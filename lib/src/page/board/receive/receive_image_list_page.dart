...
class ReceiveImageListPage extends GetView<ReceiveBoardController> {
  ReceiveImageListPage({Key? key}) : super(key: key);
          ...
          Stack(
            ...
            children: [
                ...
                child: Obx(
                  () => PhotoViewGallery.builder(
                    ...
                    itemCount: controller
                        .receiveItemListdata[index].imageDownloadUrls!.length,
              ...
              Container(
                ...
                child: Obx(
                  () => Text(
                      '${controller.imageFullListNum.value} / ${controller.receiveItemListdata[index].imageDownloadUrls!.length}',
