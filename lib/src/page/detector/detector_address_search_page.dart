...
class DetectorAddressSearchPage extends GetView<AddressSearchController> {
  const DetectorAddressSearchPage({Key? key}) : super(key: key);
          ...
          child: GestureDetector(
            onTap: () {
              FocusScope.of(context).requestFocus(
                  FocusNode()); // TextFormField에서 포커스 사라질 시 키보드 숨김
            },
            child: Container(
                      ...
                      decoration: InputDecoration(
                          ...
                          border: const UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color:
                                      Colors.grey)), // 언더라인을 설정 여러가지를 변경할 수 있음
                      ...
                      () => Expanded(
                        child: ListView.builder(
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              onTap: () async {
                                await controller.testAddress(index);
